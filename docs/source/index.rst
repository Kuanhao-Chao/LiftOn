...
3. For researchers interested in using T2T-CHM13 annotations, try LiftOn! We have pre-generated the `JHU_LiftOn_v1.0.12_chm13v2.0.gff3 <ftp://ftp.ccb.jhu.edu/pub/data/LiftOn/JHU_LiftOn_v1.0.12_chm13v2.0.gff3>`_ file for your convenience. 
