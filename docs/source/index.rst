...
.. image:: https://img.shields.io/badge/version-v1.0.14-blue
    :target: https://img.shields.io/badge/version-v1.0.14-blue
...
target locus by default (``--no-rescue-second-locus`` opts out). It also bounds
isoform-rescue memory and improves the windowed aligner. Output fixes prevent
duplicated or intron-spanning CDS blocks, overlapping exons, and misbound
trans-spliced gene fragments. On assembly-matched sorghum RefSeq annotation,
51 of 53 new rice-to-sorghum second-locus models match distinct protein-coding
target genes with at least 50% reciprocal CDS overlap; every baseline feature
row remains present. See :doc:`content/changelog` for details.
...
3. For researchers interested in using T2T-CHM13 annotations, try LiftOn! We have pre-generated the `JHU_LiftOn_v1.0.14_chm13v2.0.gff3 <ftp://ftp.ccb.jhu.edu/pub/data/LiftOn/JHU_LiftOn_v1.0.14_chm13v2.0.gff3>`_ file for your convenience. 
...
.. raw:: html
    ...
    <p>Kuan-Hao Chao, Alan Mao, Steven L. Salzberg, and Mihaela Pertea. <i>"Combining DNA and protein alignments to improve genome annotation with LiftOn."</i> <b>Genome Research</b> 35.2, 311-325 (2025).
    <a href="https://doi.org/10.1101/gr.279620.124" target="_blank"> <svg xmlns="http://www.w3.org/2000/svg" aria-hidden="true" x="0px" y="0px" viewBox="0 0 100 100" width="15" height="15" class="icon outbound"><path fill="currentColor" d="M18.8,85.1h56l0,0c2.2,0,4-1.8,4-4v-32h-8v28h-48v-48h28v-8h-32l0,0c-2.2,0-4,1.8-4,4v56C14.8,83.3,16.6,85.1,18.8,85.1z"></path> <polygon fill="currentColor" points="45.7,48.7 51.3,54.3 77.2,28.5 77.2,37.2 85.2,37.2 85.2,14.9 62.8,14.9 62.8,22.9 71.5,22.9"></polygon></svg> </a> </p>
...
.. toctree::
    ...
    content/how_to_page
    content/large_genome_resource_failures
