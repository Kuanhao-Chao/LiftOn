...
<a class="reference external image-reference" href="https://img.shields.io/badge/version-v1.0.10-blue"><img alt="https://img.shields.io/badge/version-v1.0.10-blue" src="https://img.shields.io/badge/version-v1.0.10-blue"></a>
...
<h2>What's new in v1.0.10<a class="headerlink" href="#whats-new" title="Permalink to this heading">#</a></h2>
<p>LiftOn v1.0.10 builds on v1.0.9's whole-genome robustness with a third best-of-outcome merge candidate (miniprot's native CDS-only model), a divergence-adaptive miniprot-only rescue floor, output that is complete and spec-valid enough to hand downstream unedited, and a large byte-neutral speed and memory reduction &#8212; GFF3 validation alone drops from 5.64&nbsp;GB to 267&nbsp;MB on a full mammalian lift. It also fixes ten reported issues, including a DNA-lift SQL error that made the same input succeed on one machine and fail on another (GH&nbsp;#35) and a single bad alignment taking a whole chromosome with it (GH&nbsp;#39). See the full <a class="reference external" href="https://github.com/Kuanhao-Chao/LiftOn/blob/main/CHANGELOG.md">CHANGELOG.md</a> for details.</p>
