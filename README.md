...
<a class="reference external image-reference" href="https://img.shields.io/badge/version-v1.0.11-blue"><img alt="https://img.shields.io/badge/version-v1.0.11-blue" src="https://img.shields.io/badge/version-v1.0.11-blue"></a>
...
<h2>What's new in v1.0.11<a class="headerlink" href="#whats-new" title="Permalink to this heading">#</a></h2>
<p><strong>v1.0.11</strong> is a single-fix release: v1.0.10 could not ingest some annotations that earlier versions handled &#8212; notably plant genomes, and anything produced with <code>-copies</code> &#8212; aborting the run with <code>UNIQUE constraint failed: features.id</code>. Across the benchmark corpus v1.0.8 ingested 34 of 34 inputs, v1.0.10 ingested 31, and v1.0.11 is back to 34. If you lift plant genomes, upgrade. Everything below arrived in v1.0.10 and is unchanged.</p>
