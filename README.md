...
<a class="reference external image-reference" href="https://img.shields.io/badge/version-v1.0.10.1-blue"><img alt="https://img.shields.io/badge/version-v1.0.10.1-blue" src="https://img.shields.io/badge/version-v1.0.10.1-blue"></a>
...
<p>LiftOn v1.0.10 is an incremental release that builds on v1.0.9's whole-genome robustness: a third best-of-outcome merge candidate (miniprot's native CDS-only model), a divergence-adaptive miniprot-only rescue floor, coordinate-independent structural evaluation metrics, byte-neutral vendored-Liftoff speed backports, and containment-normalization / write-guard fixes that let previously-crashing full RefSeq and cross-species genomes complete and validate cleanly. See the full <a class="reference external" href="https://github.com/Kuanhao-Chao/LiftOn/blob/main/CHANGELOG.md">CHANGELOG.md</a> for details.</p>
