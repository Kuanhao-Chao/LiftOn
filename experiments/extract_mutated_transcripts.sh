...
# if [ "$TARGET" == "liftoff" ]; then


awk '$2 > $4' /ccb/salz2/kh.chao/Lifton/results/$TARGET/score.txt > /ccb/salz2/kh.chao/Lifton/results/$TARGET/score_liftoff_better.txt

wc -l /ccb/salz2/kh.chao/Lifton/results/$TARGET/score_liftoff_better.txt

awk '$2 < $4' /ccb/salz2/kh.chao/Lifton/results/$TARGET/score.txt > /ccb/salz2/kh.chao/Lifton/results/$TARGET/score_lifton_better.txt

wc -l /ccb/salz2/kh.chao/Lifton/results/$TARGET/score_lifton_better.txt