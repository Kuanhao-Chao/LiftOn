...
def process_liftoff(lifton_gene, locus, ref_db, l_feature_db, ref_id_2_m_id_trans_dict, m_feature_db, tree_dict, tgt_fai, ref_proteins, ref_trans, ref_features_dict, fw, fw_score, fw_chain, DEBUG):
    ...
    if len(exon_children) == 0:
        if lifton_gene is None:    
            ...
            for transcript in list(transcripts):
                process_liftoff(lifton_gene, transcript, ref_db, l_feature_db, ref_id_2_m_id_trans_dict, m_feature_db, tree_dict, tgt_fai, ref_proteins, ref_trans, ref_features_dict, fw, fw_score, fw_chain, DEBUG)
        else:
            ###########################
            ...
            for feature in list(features):
                process_liftoff(lifton_feature, feature, ref_db, l_feature_db, ref_id_2_m_id_trans_dict, m_feature_db, tree_dict, tgt_fai, ref_proteins, ref_trans, ref_features_dict, fw, fw_score, fw_chain, DEBUG)
    else:
        if lifton_gene is None:
            ###########################
