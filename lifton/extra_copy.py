    ...
    for mtrans in m_feature_db.features_of_type('mRNA'):
        ...
        if len(ovps) == 0:
            ...
            if extra_cp_trans_id in trans_info_dict.keys():
                ...
                new_extra_cp_trans_id = Lifton_gene_ecp.create_new_transcript(False, extra_cp_gene_id, extra_cp_trans_id, trans_entry_base, chromosome, mtrans.start, mtrans.end, trans_attrs, gene_copy_num_dict)
            ...
            #     new_extra_cp_trans_id = Lifton_gene_ecp.create_new_transcript(True, extra_cp_gene_id, extra_cp_trans_id, trans_entry_base, chromosome, mtrans.start, mtrans.end, trans_attrs, trans_copy_num_dict)
