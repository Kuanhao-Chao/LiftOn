...
#lifton -proteins /ccb/salz2/kh.chao/PR_liftoff_protein_search/data/protein.fasta -liftoffdb /ccb/salz2/kh.chao/PR_liftoff_protein_search/results/liftoff/CHM13_MANE/CHM13_MANE.sort.sorted.gff3_db -miniprotdb /ccb/salz2/kh.chao/PR_liftoff_protein_search/results/liftoff/CHM13_MANE/CHM13_MANE_miniprot.fix.sorted.gff_db /ccb/salz3/kh.chao/ref_genome/homo_sapiens/T2T-CHM13/chm13v2.0.fa

#lifton -proteins /ccb/salz2/kh.chao/PR_liftoff_protein_search/data/protein.fasta -liftoff /ccb/salz2/kh.chao/PR_liftoff_protein_search/results/liftoff/CHM13_GRCh38/CHM13_GRCh38.sort.gff3 -miniprotdb /ccb/salz2/kh.chao/PR_liftoff_protein_search/results/liftoff/CHM13_MANE/CHM13_MANE_miniprot.fix.sorted.gff_db /ccb/salz3/kh.chao/ref_genome/homo_sapiens/T2T-CHM13/chm13v2.0.fa

lifton -proteins /ccb/salz2/kh.chao/PR_liftoff_protein_search/data/protein.fasta -liftoffdb /ccb/salz2/kh.chao/PR_liftoff_protein_search/results/liftoff/CHM13_GRCh38/CHM13_GRCh38.sort.gff3_db -miniprotdb /ccb/salz2/kh.chao/PR_liftoff_protein_search/results/liftoff/CHM13_MANE/CHM13_MANE_miniprot.fix.sorted.gff_db /ccb/salz3/kh.chao/ref_genome/homo_sapiens/T2T-CHM13/chm13v2.0.fa
